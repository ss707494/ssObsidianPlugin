...
export default class GenericInputPrompt extends Modal {
    ...
    private static createButton(container: HTMLElement, text: string, callback: (evt: MouseEvent) => any) {
    ...
    private createButtonBar(mainContentContainer: HTMLDivElement) {
        ...
        GenericInputPrompt.createButton(buttonBarContainer, "Ok", this.submitClickCallback)
            .setCta().buttonEl.style.marginRight = '0';
        GenericInputPrompt.createButton(buttonBarContainer, "Cancel", this.cancelClickCallback);
